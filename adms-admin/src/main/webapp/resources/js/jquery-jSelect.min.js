    ...
    $.fn.extend({
        "jSelect": function (options) {
            ...
            $(this).each(function () {
                ...
                $(this).after($jSelect);
                $("#" + id + "_current_select .current_select_text").html($("#" + id + " option:selected").text());
