...
(function (q) {
    var H, I, J, K, L, M, u, r = {}, v = {}, w = {}, N = {
            ...
            var a = b.target, c = h.getSetting(b.data.treeId), d = "", e = null, g = "", l = "", i = null, n = null, k = null;
        ...
        C = [], D = [], E = [], F = [], G = [], h = {
            ...
            addCreatedNode: function (b, a) {
                ...
                if (!a || !c)return [];
                for (var e = b.data.key.children, g = [], l = 0, f = a.length; l < f; l++)a[l][c] == d && g.push(a[l]), g = g.concat(h.getNodesByParam(b, a[l][e], c, d));
                return g
            }, getNodesByParamFuzzy: function (b, a, c, d) {
                if (!a || !c)return [];
                for (var e = b.data.key.children,
                         g = [], d = d.toLowerCase(), l = 0, f = a.length; l < f; l++)typeof a[l][c] == "string" && a[l][c].toLowerCase().indexOf(d) > -1 && g.push(a[l]), g = g.concat(h.getNodesByParamFuzzy(b, a[l][e], c, d));
                return g
        ...
        addNodes: function (b, a, c, d, e) {
            if (!b.data.keep.leaf || !a || a.isParent)if (j.isArray(d) || (d = [d]), b.data.simpleData.enable && (d = h.transformTozTreeFormat(b, d)), a) {
                ...
                if (!a.open)i.replaceSwitchClass(a, g, f.folder.CLOSE),
                    i.replaceIcoClass(a, l, f.folder.CLOSE), a.open = !1, p.css({display: "none"});
            ...
            if (!k || e >= k.length - c.length)e = -1;
            for (var s = 0, R = c.length; s < R; s++) {
                var o = c[s];
                g && (m = (e === 0 || k.length == c.length) && s == 0, Q = e < 0 && s == c.length - 1, h.initNode(b, a, o, d,
                    m, Q, f), h.addNodeCache(b, o));
                m = [];
            ...
            var c = [], d = k(a, b);
            !d.get(0) &&
            a.parentTId && (i.appendParentULDom(b, a.getParentNode()), d = k(a, b));
            var e = k(a, f.id.UL, b);
            e.get(0) && e.remove();
            ...
            if (j.isArray(b.async.otherParam))for (e = 0, g = b.async.otherParam.length; e < g; e += 2)l[b.async.otherParam[e]] = b.async.otherParam[e + 1]; else for (var m in b.async.otherParam)l[m] = b.async.otherParam[m];
            ...
            b && (h.initCache(b),
                h.initRoot(b), m.unbindTree(b), m.unbindEvent(b), b.treeObj.empty(), delete r[b.treeId])
        }, expandCollapseNode: function (b, a, c, d, e) {
            var g = h.getRoot(b), l = b.data.key.children, p;
            if (a) {
                ...
                if (a.open == c)j.apply(e,
                    ...
                    a.isParent ? (a.open = !a.open, a.iconOpen && a.iconClose && n.attr("style", i.makeNodeIcoStyle(b, a)), a.open ? (i.replaceSwitchClass(a, g, f.folder.OPEN), i.replaceIcoClass(a, n, f.folder.OPEN), d == !1 || b.view.expandSpeed == "" ? (c.show(), j.apply(e, [])) : a[l] && a[l].length > 0 ? c.slideDown(b.view.expandSpeed, e) : (c.show(), j.apply(e, []))) : (i.replaceSwitchClass(a, g, f.folder.CLOSE), i.replaceIcoClass(a, n, f.folder.CLOSE), d == !1 || b.view.expandSpeed == "" || !(a[l] &&
                    a[l].length > 0) ? (c.hide(), j.apply(e, [])) : c.slideUp(b.view.expandSpeed, e))) : j.apply(e, [])
                }
            } else j.apply(e, [])
            ...
            if (g)for (var k = 0, m = g.length; k <
            m; k++)g[k] && i.expandCollapseSonNode(b, g[k], c, f);
        ...
        makeDOMNodeNameBefore: function (b, a, c) {
                ...
                if (!Element.prototype.scrollIntoViewIfNeeded)Element.prototype.scrollIntoViewIfNeeded =
                    function (a) {
                        ...
                        for (var d, e = this, g = b(this.offsetLeft, this.offsetTop, this.offsetWidth, this.offsetHeight); j.isElement(d =
                            e.parentNode);) {
                            var f = d.offsetLeft + d.clientLeft, h = d.offsetTop + d.clientTop, g = g.relativeFromTo(e, d).translate(-f, -h);
            ...
            if (h.getNodeCache(b,
                ...
                if (!b.data.keep.parent && g == 0)e.isParent = !1, e.open = !1, g = k(e, f.id.UL, b), j = k(e, f.id.SWITCH, b), p = k(e, f.id.ICON, b), i.replaceSwitchClass(e, j, f.folder.DOCU), i.replaceIcoClass(e, p, f.folder.DOCU), g.css("display", "none"); else if (b.view.showLine && g > 0) {
                    var n = e[d][g - 1], g = k(n, f.id.UL, b), j = k(n, f.id.SWITCH,
                        b);
                    p = k(n, f.id.ICON, b);
            ...
            c = {
                setting: d, addNodes: function (a, b, c, f) {
                    ...
                    if (this.setting.async.enable) {
                        ...
                        j && (a = h.getRoot(d));
                        if (b == "refresh") {
                            for (var b = this.setting.data.key.children, n = 0, m = a[b] ? a[b].length : 0; n < m; n++)h.removeNodeCache(d, a[b][n]);
