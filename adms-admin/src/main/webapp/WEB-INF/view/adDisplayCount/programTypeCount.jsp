...
<div class="page_content ad-data-statistics">
    <div class="col-lg-12 main-box ad-tab-box">
        ...
        <a href="${ctx}/adDisplayCount/programTypeCount" class="ad-tab-btn ad-tab-select">基于节目类型</a>
    </div>
    ...
    <div class="col-lg-12 main-box chart-legend">
        <ul id="toUl">
            <c:forEach items="${programTypeCount}" var="programTypeCount">
                <li><i></i>${programTypeCount.programTypeName}</li>
            </c:forEach>
        </ul>
    </div>
    ...
    <div class="col-lg-12 main-box">
        <button type="button" id="exportProgramType" class="export-btn normal-btn fr white-btn"
                style="margin: 15px"
        ...
        <div class="table_wrapper">
            <table>
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        <c:forEach items="${displayCountResultDTOList}" var="proTypeCount">
                            <tr>
                                <td>${proTypeCount.programTypeName}</td>
                                <td>${proTypeCount.slotCount == null ? 0 : proTypeCount.slotCount}</td>
                                <td><fmt:formatNumber type="number" value="${proTypeCount.showCounts/10000}" maxFractionDigits="2"/></td>
                                <td><fmt:formatNumber type="number" value="${null == proTypeCount.clickCounts ? 0 : proTypeCount.clickCounts}" maxFractionDigits="0" /></td>
                                <td><fmt:formatNumber type="number" value="${null == proTypeCount.ctr ? 0 : proTypeCount.ctr}" maxFractionDigits="2"/>%</td>
                                <td><fmt:formatNumber type="number" value="${proTypeCount.cash == null ? 0 : proTypeCount.cash}" maxFractionDigits="2"/></td>
                            </tr>
                        </c:forEach>
                    </c:otherwise>
                </c:choose>
...
<script type="text/javascript">
    var url = "/adDisplayCount/programTypeCount";
